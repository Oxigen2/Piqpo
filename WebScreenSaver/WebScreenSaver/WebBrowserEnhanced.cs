...
namespace WebScreenSaver
{
    ...
    public class WebBrowserEnhanced : WebBrowser
    {
        AxHost.ConnectionPointCookie cookie;
        WebBrowserEnhancedEventHelper helper;
        ...
        protected override void CreateSink()
        {
            ...
            helper = new WebBrowserEnhancedEventHelper(this);
        ...
        {
            Trace.TraceInformation("OnNavigateError");
        ...
        private class WebBrowserEnhancedEventHelper :
            StandardOleMarshalObject, DWebBrowserEvents2
        {
            private WebBrowserEnhanced parent;

            public WebBrowserEnhancedEventHelper(WebBrowserEnhanced parent)
            {
                this.parent = parent;
            }
            ...
            {
                Trace.TraceError("Navigation error caught");
    ...
    // Represents the method that will handle the WebBrowserEnhanced.NavigateError event.
    public delegate void WebBrowserNavigateErrorEventHandler(object sender,
        WebBrowserNavigateErrorEventArgs e);

    // Provides data for the WebBrowserEnhanced.NavigateError event.
